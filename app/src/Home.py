...
if st.button(
    "Act as Sebastian, a Student Co-Op Searcher",
    type="primary",
...
if st.button(
    "Act as Riley, a student Co-Op Reviewer", type="primary", use_container_width=True
):
    st.session_state["authenticated"] = True
...
if st.button(
    "Act as Alex Admin, System Administrator", type="primary", use_container_width=True
):
    st.session_state["authenticated"] = True
...
if st.button(
    "Act as Annalise, an Analysist of Site Performance",
    type="primary",
    use_container_width=True,
):
    st.session_state["authenticated"] = True
